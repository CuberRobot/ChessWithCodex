...
| 找棋谱 | **预置了 5 盘经典短局**（Légal 陷阱、歌剧院之战、Réti–Tartakower 1910，以及三步杀/四步杀/贪吃中兵的教学局）；也可以用 `fetch_games.py` 从 Lichess 按棋手拉，或下载任意 PGN 链接（**只收着法，不收录他人评注**，版权说明见 `docs/game-library-plan.md`） |
